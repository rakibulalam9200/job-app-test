    ...
    return (
        <Div ml={16} style={{paddingTop: Platform.OS === 'android' ? 25 : 0,}}>
            ...
            <Div color="normalText">
                <Text fontSize="lg" mb={20}>We've send you an email with OTP code, please fill the form bellow and hit enter to reset your password</Text>
            ...
            <Div color="normalText">
                ...
                <Input focusBorderColor="inputOutline" placeholder="Re-Type New Password" mr={16} rounded="lg" fontSize="lg"
                       secureTextEntry
